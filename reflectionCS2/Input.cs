...
using System.Text;
using System.Threading.Tasks;
using static reflectionCS2.PInvoke.User32;
...
namespace reflectionCS2
{
    public static class Input
    {
        ...
        public static bool IsKeyDown(int vKey) => GetAsyncKeyState(vKey) < 0;

        public static void PressKey(ScanCodeShort buttonScanCodeShort, int count = 1)
        {
        ...
        private static global::GameOverlay.Drawing.Point GetCursorPosition()
        {
            POINT lpPoint;
        ...
        public static global::GameOverlay.Drawing.Point CursorPos
        {
            get; private set;
        }
        ...
        public struct POINT
        {
            ...
            public static implicit operator global::GameOverlay.Drawing.Point(POINT point)
            {
                return new global::GameOverlay.Drawing.Point(point.X, point.Y);
            }
        }
        ...
        public class Key
        {
            ...
            public void Update()
            {
                bool down = Input.IsKeyDown(vkCode);
                if (down)
                {
                    if (state == 0)
                        state = Input.KeyState.PRESSED;
                    else if (state == Input.KeyState.PRESSED)
