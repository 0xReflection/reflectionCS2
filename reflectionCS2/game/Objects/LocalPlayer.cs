...
namespace reflectionCS2.game.Objects
{
    internal class LocalPlayer : EntityBase
    {
        ...
        {
            return Memory.Read<nint>(Memory.ClientPtr + ClientOffsets.dwLocalPlayerPawn);
        }

        public override nint ReadControllerBase()
        {
            return Memory.Read<nint>(Memory.ClientPtr + ClientOffsets.dwLocalPlayerController);
        }
        public override bool Update()
        {
            ...
            Weapon.Update(Memory.Read<nint>(AddressBase + C_CSPlayerPawnBase.m_pClippingWeapon));
