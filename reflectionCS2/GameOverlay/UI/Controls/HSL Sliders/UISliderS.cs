...
namespace reflectionCS2.GameOverlay.UI.Controls.HSL_Sliders
{
    internal class UISliderS : UISlider
    {
        public UISliderS(float value) : base(value)
        {
        ...
        public override void Draw(Graphics graphics)
        {
            ...
            RawColor4 color1 = ColorConverter.ColorFromHSL(h, 0, l);
            RawColor4 color2 = ColorConverter.ColorFromHSL(h, 1, l);
            ...
            Brushes.Share.Color = ColorConverter.ColorFromHSL(h, Value / 100, l);
